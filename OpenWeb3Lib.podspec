Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/web3user1/OpenWeb3-IOS.git', :tag => "1.0.4" }
  s.requires_arc = true

  s.vendored_frameworks = 'Frameworks/swift5.9/OpenWeb3Lib.xcframework'
