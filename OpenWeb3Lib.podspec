Pod::Spec.new do |s|
  s.name         = 'OpenWeb3Lib'
  s.version      = '1.0.4-fixed.1'
  s.summary      = 'OpenWbLib is a powerful library for interacting with Web3 technologies.'
  ...
  s.source       = { :git => 'https://github.com/web3user1/OpenWeb3-IOS.git', :tag => '1.0.4-fixed.1' }
  s.requires_arc = true
